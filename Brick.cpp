...
void Brick::update(float dt)
{
	...
	if (ballPos.x + radius >= pos.x &&ballPos.x - radius <= pos.x &&ballPos.y >= pos.y &&ballPos.y <= pos.y + brick_height) 
	{
	...
	if (ballPos.x - radius <= pos.x + brick_width &&ballPos.x + radius >= pos.x + brick_width &&ballPos.y >= pos.y &&ballPos.y <= pos.y + brick_height)
	{
	...
	if (ballPos.y - radius <= pos.y + brick_height &&ballPos.y + radius >= pos.y + brick_height &&ballPos.x - radius >= pos.x &&ballPos.x + radius <= pos.x + brick_width) 
	{
	...
	if (ballPos.y + radius >= pos.y &&ballPos.y - radius <= pos.y &&ballPos.x - radius >= pos.x &&ballPos.x + radius <= pos.x + brick_width) 
	{
